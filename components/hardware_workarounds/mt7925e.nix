	...
	boot.kernelPatches = [
		{
			...
			patch = pkgs.fetchurl {
				url = "https://raw.githubusercontent.com/zbowling/mt7925/443b75bc7fd7ddb35e22c76bf47ec12c2628294a/kernels/6.18/0001-wifi-mt76-mt7925-fix-NULL-pointer-dereference-in-vif.patch";
		...
		}
		{
			...
			patch = pkgs.fetchurl {
				url = "https://raw.githubusercontent.com/zbowling/mt7925/443b75bc7fd7ddb35e22c76bf47ec12c2628294a/kernels/6.18/0002-wifi-mt76-mt7925-fix-missing-mutex-protection-in-res.patch";
		...
		}
		{
			...
			patch = pkgs.fetchurl {
				url = "https://raw.githubusercontent.com/zbowling/mt7925/443b75bc7fd7ddb35e22c76bf47ec12c2628294a/kernels/6.18/0003-wifi-mt76-mt7925-fix-missing-mutex-protection-in-run.patch";
		...
		}
		{
			...
			patch = pkgs.fetchurl {
				url = "https://raw.githubusercontent.com/zbowling/mt7925/443b75bc7fd7ddb35e22c76bf47ec12c2628294a/kernels/6.18/0004-wifi-mt76-mt7925-add-NULL-checks-in-MCU-STA-TLV-func.patch";
		...
		}
		{
			...
			patch = pkgs.fetchurl {
				url = "https://raw.githubusercontent.com/zbowling/mt7925/443b75bc7fd7ddb35e22c76bf47ec12c2628294a/kernels/6.18/0005-wifi-mt76-mt7925-add-NULL-checks-for-link_conf-and-m.patch";
		...
		}
		{
			...
			patch = pkgs.fetchurl {
				url = "https://raw.githubusercontent.com/zbowling/mt7925/443b75bc7fd7ddb35e22c76bf47ec12c2628294a/kernels/6.18/0006-wifi-mt76-mt7925-add-error-handling-for-AMPDU-MCU-co.patch";
		...
		}
		{
			...
			patch = pkgs.fetchurl {
				url = "https://raw.githubusercontent.com/zbowling/mt7925/443b75bc7fd7ddb35e22c76bf47ec12c2628294a/kernels/6.18/0007-wifi-mt76-mt7925-add-error-handling-for-BSS-info-MCU.patch";
		...
		}
		{
			...
			patch = pkgs.fetchurl {
				url = "https://raw.githubusercontent.com/zbowling/mt7925/443b75bc7fd7ddb35e22c76bf47ec12c2628294a/kernels/6.18/0008-wifi-mt76-mt7925-add-error-handling-for-BSS-info-in-.patch";
		...
		}
		{
			...
			patch = pkgs.fetchurl {
				url = "https://raw.githubusercontent.com/zbowling/mt7925/443b75bc7fd7ddb35e22c76bf47ec12c2628294a/kernels/6.18/0009-wifi-mt76-mt7925-add-NULL-checks-in-MLO-link-and-cha.patch";
		...
		}
		{
			...
			patch = pkgs.fetchurl {
				url = "https://raw.githubusercontent.com/zbowling/mt7925/443b75bc7fd7ddb35e22c76bf47ec12c2628294a/kernels/6.18/0010-wifi-mt76-mt792x-fix-NULL-pointer-dereference-in-TX-.patch";
		...
		}
		{
			...
			patch = pkgs.fetchurl {
				url = "https://raw.githubusercontent.com/zbowling/mt7925/443b75bc7fd7ddb35e22c76bf47ec12c2628294a/kernels/6.18/0011-wifi-mt76-mt7925-add-lockdep-assertions-for-mutex-ve.patch";
		...
		}
		{
			...
			patch = pkgs.fetchurl {
				url = "https://raw.githubusercontent.com/zbowling/mt7925/443b75bc7fd7ddb35e22c76bf47ec12c2628294a/kernels/6.18/0012-wifi-mt76-mt7925-fix-key-removal-failure-during-MLO-.patch";
		...
		}
		{
			...
			patch = pkgs.fetchurl {
				url = "https://raw.githubusercontent.com/zbowling/mt7925/443b75bc7fd7ddb35e22c76bf47ec12c2628294a/kernels/6.18/0013-wifi-mt76-mt7925-fix-kernel-warning-in-MLO-ROC-setup.patch";
		...
		}
		{
			...
			patch = pkgs.fetchurl {
				url = "https://raw.githubusercontent.com/zbowling/mt7925/443b75bc7fd7ddb35e22c76bf47ec12c2628294a/kernels/6.18/0014-wifi-mt76-mt7925-add-NULL-checks-for-MLO-link-pointe.patch";
		...
		}
		{
			...
			patch = pkgs.fetchurl {
				url = "https://raw.githubusercontent.com/zbowling/mt7925/443b75bc7fd7ddb35e22c76bf47ec12c2628294a/kernels/6.18/0015-wifi-mt76-mt792x-fix-firmware-reload-failure-after-p.patch";
		...
		}
		{
			...
			patch = pkgs.fetchurl {
				url = "https://raw.githubusercontent.com/zbowling/mt7925/443b75bc7fd7ddb35e22c76bf47ec12c2628294a/kernels/6.18/0016-wifi-mt76-mt7925-add-mutex-protection-in-resume-path.patch";
		...
		}
		{
			...
			patch = pkgs.fetchurl {
				url = "https://raw.githubusercontent.com/zbowling/mt7925/443b75bc7fd7ddb35e22c76bf47ec12c2628294a/kernels/6.18/0017-wifi-mt76-mt7925-add-NULL-checks-for-link-pointers-i.patch";
		...
		}
		{
			...
			patch = pkgs.fetchurl {
				url = "https://raw.githubusercontent.com/zbowling/mt7925/443b75bc7fd7ddb35e22c76bf47ec12c2628294a/kernels/6.18/0018-wifi-mt76-mt7921-fix-mutex-handling-in-multiple-path.patch";
		...
		}
		{
			...
			patch = pkgs.fetchurl {
				url = "https://raw.githubusercontent.com/zbowling/mt7925/443b75bc7fd7ddb35e22c76bf47ec12c2628294a/kernels/6.18/0019-wifi-mt76-fix-list-corruption-in-mt76_wcid_cleanup.patch";
		...
		}
		{
			...
			patch = pkgs.fetchurl {
				url = "https://raw.githubusercontent.com/zbowling/mt7925/443b75bc7fd7ddb35e22c76bf47ec12c2628294a/kernels/6.18/0020-wifi-mt76-mt7925-fix-BA-session-teardown-during-beac.patch";
